...
EMovieSceneChannelProxyType UMovieSceneEvtAdxSoundFadeSection::CacheChannelProxy() {
	...
	Channels.Add(EventData, Metadata, TMovieSceneExternalValue<FEvtAdxSoundFadePayload>());
#endif
