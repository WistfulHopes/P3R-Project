...
EMovieSceneChannelProxyType UMovieSceneEvtSeqControllerSection::CacheChannelProxy() {
	...
	Channels.Add(EventData, Metadata, TMovieSceneExternalValue<FEvtSeqControllerPayload>());
#endif
