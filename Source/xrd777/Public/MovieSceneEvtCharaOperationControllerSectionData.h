...
public:
	 ...
	 */
	FORCEINLINE TMovieSceneChannelData<FEvtCharaOperationControllerPayload> GetData()
	{
		return TMovieSceneChannelData<FEvtCharaOperationControllerPayload>(&Times, &KeyValues, &KeyHandles);
	}
	 ...
	 */
	FORCEINLINE TMovieSceneChannelData<const FEvtCharaOperationControllerPayload> GetData() const
	{
		return TMovieSceneChannelData<const FEvtCharaOperationControllerPayload>(&Times, &KeyValues);
	}
	...
	bool Evaluate(FFrameTime InTime, FEvtCharaOperationControllerPayload& OutValue) const { return true; }
...
public:
	...
	const TArray<FEvtCharaOperationControllerPayload>& GetValues() const { return KeyValues; }
public:
    XRD777_API FMovieSceneEvtCharaOperationControllerSectionData();
};

template<>
struct TMovieSceneChannelTraits<FMovieSceneEvtCharaOperationControllerSectionData> : TMovieSceneChannelTraitsBase<FMovieSceneEvtCharaOperationControllerSectionData>
{
#if WITH_EDITOR
    /** Byte channels can have external values (ie, they can get their values from external objects for UI purposes) */
    typedef TMovieSceneExternalValue<FEvtCharaOperationControllerPayload> ExtendedEditorDataType;
#endif
};
...
{
    template<> inline FName GetKeyTypeName<FEvtCharaOperationControllerPayload>()
    {
        return "FEvtCharaOperationControllerPayload";
    }
}
#endif