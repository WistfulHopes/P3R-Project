...
public:
	...
	void BuildEventConditionalBranchMenu(FMenuBuilder& Builder, UMovieSceneEvtCharaOperationControllerTrack* Track);
	void SetEvtManagerBindingID(UMovieSceneEvtCharaOperationControllerTrack* Track);
