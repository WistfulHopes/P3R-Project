...
public:
	 ...
	 */
	FORCEINLINE TMovieSceneChannelData<FEvtSeqTimeJumpControllerPayload> GetData()
	{
		return TMovieSceneChannelData<FEvtSeqTimeJumpControllerPayload>(&Times, &KeyValues, &KeyHandles);
	}
	 ...
	 */
	FORCEINLINE TMovieSceneChannelData<const FEvtSeqTimeJumpControllerPayload> GetData() const
	{
		return TMovieSceneChannelData<const FEvtSeqTimeJumpControllerPayload>(&Times, &KeyValues);
	}
	...
	bool Evaluate(FFrameTime InTime, FEvtSeqTimeJumpControllerPayload& OutValue) const { return true; }
...
public:
	...
	const TArray<FEvtSeqTimeJumpControllerPayload>& GetValues() const { return KeyValues; }
public:
    FMovieSceneEvtSeqTimeJumpControllerSectionData();
};

template<>
struct TMovieSceneChannelTraits<FMovieSceneEvtSeqTimeJumpControllerSectionData> : TMovieSceneChannelTraitsBase<FMovieSceneEvtSeqTimeJumpControllerSectionData>
{
#if WITH_EDITOR
    /** Byte channels can have external values (ie, they can get their values from external objects for UI purposes) */
    typedef TMovieSceneExternalValue<FEvtSeqTimeJumpControllerPayload> ExtendedEditorDataType;
#endif
};
...
{
    template<> inline FName GetKeyTypeName<FEvtSeqTimeJumpControllerPayload>()
    {
        return "FEvtSeqTimeJumpControllerPayload";
    }
}
#endif